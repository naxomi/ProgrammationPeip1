...
def draw_saloon_sign(x, y, lengthMainStructure, heightMainStructure, xShiftFromBaseToStructure, factor):
	...
	fontSize = 52 * factor
	color(91, 69, 47)
	va(x + lengthMainStructure / 2 + xShiftFromBaseToStructure, yForSign + signWidth / 2 - fontSize*2/3)
	write("SALOON", False, align="center", font=("Playbill", int(fontSize), "normal"))
